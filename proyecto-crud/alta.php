...
<?php
    ...
    // $insert = mysqli_query($con,"SELECT * FROM user WHERE usuario='" . $_POST["usuario"] . "' and password = '". md5($_POST["password"])."';");
    // $insert = mysqli_query($con,"INSERT INTO usuarios ( `nombre`, `apellido`, `usuario`, `email`, `contraseña`, `nacimiento`, `telefono`) VALUES ('".$_POST[""]."','".$_POST[""]."','".$_POST[""]."','".$_POST[""]."','".$_POST[""]."','".$_POST[""]."','".$_POST[""]."');");
